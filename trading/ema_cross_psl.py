...
def download_data(ticker: str, years: int, use_hourly: bool) -> pl.DataFrame:
    ...
    Args:
        ...
        use_hourly (bool): If True, download hourly data; otherwise, download daily data.

    Returns:
        pl.DataFrame: A DataFrame containing the downloaded historical data.

    Raises:
        Exception: If there's an error downloading the data.
    """
