...
TICKER_1: str = 'SPY'  # Ticker for X to USD
TICKER_2: str = 'QQQ'  # Ticker for Y to USD
EMA_FAST: int = 10  # Fast EMA period
EMA_SLOW: int = 30  # Slow EMA period
...
def main() -> None:
    ...
    atr_lengths: List[int] = list(range(2, 13))
    atr_multipliers: List[float] = list(np.arange(1, 8.5, 0.5))
