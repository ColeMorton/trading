...
from .queries.ticker_queries import (
    get_tickers,
    get_ticker,
    get_price_data,
...
class Query:
    ...
    portfolio_metrics: List[PortfolioMetrics] = strawberry.field(resolver=get_portfolio_metrics)
    ...
    strategy_configurations: List[StrategyConfiguration] = strawberry.field(resolver=get_strategy_configurations)
    backtest_results: List[BacktestResult] = strawberry.field(resolver=get_backtest_results)
...
class Mutation:
    ...
    add_strategy_to_portfolio: bool = strawberry.field(resolver=add_strategy_to_portfolio)
    remove_strategy_from_portfolio: bool = strawberry.field(resolver=remove_strategy_from_portfolio)
    ...
    create_strategy_configuration: StrategyConfiguration = strawberry.field(resolver=create_strategy_configuration)
    update_strategy_configuration: Optional[StrategyConfiguration] = strawberry.field(resolver=update_strategy_configuration)
    delete_strategy_configuration: bool = strawberry.field(resolver=delete_strategy_configuration)
    
    # Analysis mutations
    execute_ma_cross_analysis: Union[MACrossAnalysisResponse, AsyncAnalysisResponse] = strawberry.field(resolver=execute_ma_cross_analysis)
    get_analysis_status: Optional[AnalysisStatus] = strawberry.field(resolver=get_analysis_status)
