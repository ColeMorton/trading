...
class ScriptExecutionResponse(BaseResponse):
    ...
    """
    status: str = "success"
    execution_id: Optional[str] = Field(None, description="Unique identifier for the execution")
...
class ScriptInfo(BaseModel):
    ...
    parameters: Dict[str, str] = Field(..., description="Parameters accepted by the script")
