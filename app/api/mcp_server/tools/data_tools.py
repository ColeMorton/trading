...
class DataTools:
    ...
    async def list_data_files(self, directory: str = "") -> Dict[str, Any]:
        ...
        try:
            ...
            result = {"success": True, "directories": {}, "total_files": 0}
            ...
            mock_files = {
                "csv": [
                    {
                        "name": "strategies/DAILY.csv",
                        "size": 15420,
                        "modified": "2025-05-26T10:30:00",
                    },
                    {
                        "name": "backtest_results.csv",
                        "size": 8943,
                        "modified": "2025-05-25T14:22:00",
                    },
                    {
                        "name": "portfolio_history.csv",
                        "size": 23156,
                        "modified": "2025-05-24T09:15:00",
                    },
                ],
                "json": [
                    {
                        "name": "config/trading_params.json",
                        "size": 1245,
                        "modified": "2025-05-20T08:00:00",
                    },
                    {
                        "name": "market_data.json",
                        "size": 45782,
                        "modified": "2025-05-26T11:00:00",
                    },
                ],
            }
            ...
            logger.info(
                "Listed data files successfully",
            ...
            return {"success": False, "error": f"Failed to list data files: {str(e)}"}
    ...
    async def get_trading_data(self, file_path: str, file_type: str) -> Dict[str, Any]:
        ...
        try:
            logger.info(
                "Retrieving trading data", file_path=file_path, file_type=file_type
            )
            ...
            try:
                ...
                logger.info(
                    "Retrieved trading data successfully",
                    file_path=file_path,
                    file_type=file_type,
                )
                ...
                if "404" in error_msg:
                    ...
                    error_msg = (
                        f"Access denied: {file_path} is not in an allowed directory"
                    )
