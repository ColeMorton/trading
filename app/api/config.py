...
def is_path_allowed(path: str, allowed_dirs: List[str], base_dir: Optional[str] = None) -> bool:
    """
    ...
    for allowed_dir in allowed_dirs:
        ...
        if normalized_path.startswith(allowed_dir + '/') or normalized_path == allowed_dir:
            return True
