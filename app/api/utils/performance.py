...
class ConcurrentExecutor:
    ...
    def _initialize_executors(self) -> None:
        ...
        self._thread_pool = ThreadPoolExecutor(
            ...
            thread_name_prefix="ma_cross_api"
        )
    ...
    async def execute_analysis(
        ...
        **kwargs
        ...
        try:
            ...
            future.cancel()
            raise TimeoutError(f"Analysis execution timed out after {self.config.request_timeout} seconds")
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            "thread_pool": {
                ...
                "active": hasattr(self._thread_pool, '_threads') and len(self._thread_pool._threads) if self._thread_pool else 0
            }
        }
        ...
        if self._process_pool:
            stats["process_pool"] = {
                ...
                "active": len(self._process_pool._processes) if hasattr(self._process_pool, '_processes') else 0
            }
...
class RequestOptimizer:
    ...
    def _record_timing(self, operation_name: str, execution_time: float, success: bool) -> None:
        ...
        with self._lock:
            ...
            if len(self._timing_stats[operation_name]) >= 100:
                self._timing_stats[operation_name] = self._timing_stats[operation_name][-50:]
