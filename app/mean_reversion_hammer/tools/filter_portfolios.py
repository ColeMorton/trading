...
mean reversion hammer strategy, creating summaries of extreme values.
"""
...
def filter_portfolios(df: pl.DataFrame, config: ExportConfig, log: Callable) -> pl.DataFrame:
    """Filter and analyze portfolio metrics for the hammer strategy, creating a summary of extreme values.
