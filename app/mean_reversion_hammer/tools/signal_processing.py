...
from app.mean_reversion_hammer.tools.sensitivity_analysis import analyze_parameter_combination
...
def process_ticker_portfolios(ticker: str, config: PortfolioConfig, log: Callable) -> Optional[pl.DataFrame]:
    ...
    try:
        if config.get("USE_CURRENT", False):
            ...
            from app.mean_reversion_hammer.tools.portfolio_processing import process_single_ticker
