...
from app.ma_cross.core import AnalysisConfig, AnalysisResult, TickerResult
...
class ScannerAdapter:
    ...
    def process_portfolio_file(self, portfolio_path: str, config: Dict[str, Any]) -> AnalysisResult:
        """
    ...
    def _process_ticker_row(self, ticker: str, row: Dict[str, Any], config: Dict[str, Any]) -> List[TickerResult]:
        """
        ...
        try:
            ...
            if result:
                ...
                from app.ma_cross.core.models import SignalInfo
