...
class StructuredLogger:
    ...
    def _format_json_log(self, level: str, message: str, context: Dict[str, Any] = None) -> str:
    ...
    def error(self, message: str, context: Dict[str, Any] = None, exc_info: bool = False) -> None:
    ...
    def critical(self, message: str, context: Dict[str, Any] = None, exc_info: bool = False) -> None:
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                logger.debug(f"Method completed: {func.__name__} in {execution_time:.4f} seconds")
