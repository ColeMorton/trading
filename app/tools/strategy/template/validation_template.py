        ...
        if self.config.strategy_type.value == "moving_average":
            lines.extend(
                [
                    ...
                    f'{indent}    config["SHORT_WINDOW"] = 50',
                    f'{indent}    config["LONG_WINDOW"] = 20',
                    f"{indent}    ",
                    f'{indent}    with pytest.raises(ValueError, match="Short window must be less than long window"):',
                    ...
                    f"{indent}    config = DEFAULT_CONFIG.copy()",
                    f'{indent}    config["SHORT_WINDOW"] = 0',
                    f"{indent}    ",
