...
class ConvergenceAnalyzer:
    ...
    async def analyze_multi_timeframe_convergence(
        ...
        try:
            ...
            self.logger.error(f"Multi-timeframe convergence analysis failed: {e}")
            raise
    ...
    async def analyze_cross_strategy_convergence(
        ...
        try:
            ...
            self.logger.error(f"Cross-strategy convergence analysis failed: {e}")
            raise
    ...
    async def analyze_statistical_convergence(
        ...
        try:
            ...
            self.logger.error(f"Statistical convergence analysis failed: {e}")
            raise
