...
class TestHorizonAnalysis(unittest.TestCase):
    ...
    def test_no_forward_looking_bias(self):
        ...
        returns = np.array([0.01, 0.01, 0.02, 0.03, 0.01, -0.01, -0.02, -0.03, -0.01, 0.01])
    ...
    def test_position_based_evaluation(self):
        ...
        returns = np.array([0.01, 0.01, -0.02, 0.03, 0.01, 0.02, -0.02, -0.03, 0.01, 0.01])
    ...
    def test_find_best_horizon(self):
        ...
        best_horizon_low_threshold = _find_best_horizon(horizon_metrics, min_sample_size=10)
