...
def get_stop_loss_value(strategy_config: Dict[str, Any], global_config: Dict[str, Any]) -> Optional[float]:
    ...
    if stop_loss_config.mode == StopLossMode.OPTIONAL:
        ...
        return strategy_stop_loss if strategy_stop_loss is not None else stop_loss_config.default_value
