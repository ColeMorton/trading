...
# ASSETS = ['SOL-USD', 'BTC-USD', 'FDS', 'ALGN', 'EW', 'JD', 'CSX', 'WDC', 'POOL', 'AAPL', 'NTES', 'SIRI', 'AMD', 'NVDA', 'MCD', 'MSTR']

ASSETS = ['SOL-USD', 'BTC-USD', 'FDS', 'ALGN', 'EW', 'JD', 'CSX', 'WDC', 'POOL', 'AAPL', 'NTES', 'SIRI', 'AMD', 'NVDA', 'MCD', 'MSTR', 'ZS', 'GOOGL', 'GFS', 'CLX', 'LOW', 'LRCX']
