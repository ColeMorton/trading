...
# ASSETS = ['SOL-USD', 'BTC-USD', 'HES', 'FDS', 'CMG', 'ALGN', 'CB', 'EW', 'LOW', 'CSX', 'WDC', 'AMZN', 'FSLR', 'POOL', 'AAPL', 'NTES']

ASSETS = ['SOL-USD', 'BTC-USD', 'HES', 'FDS', 'CMG', 'ALGN', 'CB', 'EW', 'LOW', 'CSX', 'WDC', 'AMZN', 'FSLR', 'POOL', 'AAPL', 'NTES', 'SIRI', 'META', 'LRCX', 'MSFT', 'NVDA']
