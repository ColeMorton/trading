...
# ASSETS = ['SOL-USD', 'BTC-USD', 'ALGN', 'JD', 'WDC', 'AAPL', 'NTES', 'MCD', 'PARA', 'STZ', 'CRWD', 'MSTR', 'WST', 'LRCX'],

ASSETS = ['SOL-USD', 'BTC-USD', 'ALGN', 'AAPL', 'NTES', 'MCD', 'PARA', 'CRWD', 'MSTR', 'WST', 'LRCX', 'SMH','ROKU','TSM']
