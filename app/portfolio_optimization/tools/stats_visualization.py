...
from app.portfolio_optimization.tools.types import ConcurrencyStats
...
def create_stats_annotation(
    ...
    try:
        ...
        required_fields = ['start_date', 'end_date', 'total_periods', 'total_concurrent_periods',
                         'concurrency_ratio', 'exclusive_ratio', 'inactive_ratio',
                         'avg_concurrent_strategies', 'max_concurrent_strategies',
        ...
        efficiency_fields = ['total_expectancy', 'diversification_multiplier',
                           'independence_multiplier', 'activity_multiplier',
                           'efficiency_score']
