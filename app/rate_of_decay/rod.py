...
def model_loss_streaks(initial_equity, risk_percentage, max_streak_length, loss_probability):
    """
    ...
    equity_values = calculate_equity_curve(initial_equity, risk_percentage, max_streak_length)
...
def main():
    ...
    # Model loss streaks
    streak_data = model_loss_streaks(initial_equity, risk_percentage, max_streak_length, loss_probability)
