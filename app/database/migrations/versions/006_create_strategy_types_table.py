...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("strategy_type", sa.String(50), nullable=False, unique=True, index=True),
    ...
    op.drop_index("ix_strategy_sweep_ticker_id_strategy", table_name="strategy_sweep_results")
...
def downgrade() -> None:
    ...
    op.drop_index("ix_strategy_sweep_ticker_id_strategy_type_id", table_name="strategy_sweep_results")
