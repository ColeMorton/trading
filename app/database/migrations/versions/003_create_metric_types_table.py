...
METRIC_TYPES_SEED_DATA = [
    ...
    ("Most Avg Winning Trade Duration", "timing", "Longest average winning trade duration"),
    ("Mean Avg Winning Trade Duration", "timing", "Average winning trade duration"),
    ("Most Avg Losing Trade Duration", "timing", "Longest average losing trade duration"),
    ...
    ("Median Avg Winning Trade [%]", "trade", "Median average winning trade percentage"),
    ("Mean Avg Winning Trade [%]", "trade", "Average winning trade percentage"),
    ("Most Avg Losing Trade [%]", "trade", "Highest average losing trade percentage (least negative)"),
...
def downgrade() -> None:
    ...
    op.drop_index("ix_sweep_result_metrics_type", table_name="strategy_sweep_result_metrics")
    op.drop_index("ix_sweep_result_metrics_result", table_name="strategy_sweep_result_metrics")
    op.drop_constraint("uq_sweep_result_metric", "strategy_sweep_result_metrics", type_="unique")
    op.drop_constraint("fk_sweep_result_metrics_type_id", "strategy_sweep_result_metrics", type_="foreignkey")
    op.drop_constraint("fk_sweep_result_metrics_result_id", "strategy_sweep_result_metrics", type_="foreignkey")
