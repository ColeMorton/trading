"""CLI configuration models for seasonality analysis.

Domain models (PatternType, SeasonalityPattern, SeasonalityResult) have been moved
to app.tools.models.seasonality to break circular import dependencies.
"""
