...
def visualize_performance(csv_file):
    ...
    x_range = np.linspace(min(final_portfolio_values), max(final_portfolio_values), 1000)
    kde_values = kde(x_range)

    # Plot histogram
    plt.hist(final_portfolio_values, bins=50, edgecolor='black', density=True, alpha=0.7)
