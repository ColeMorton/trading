                ...
                if ticker_result.has_current_signal:
                    for signal in ticker_result.current_signals:
                        result_dict = {
                            ...
                            "SMA_FAST": signal.short_window
                            if signal.ma_type == "SMA"
                            else None,
                            "SMA_SLOW": signal.long_window
                            if signal.ma_type == "SMA"
                            else None,
                            "EMA_FAST": signal.short_window
                            if signal.ma_type == "EMA"
                            else None,
                            "EMA_SLOW": signal.long_window
                            if signal.ma_type == "EMA"
                            else None,
                        }
