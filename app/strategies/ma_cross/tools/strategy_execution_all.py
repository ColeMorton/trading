...
def process_ticker_portfolios_all(
    ...
    filtered_df = filter_service.filter_portfolios_dataframe(portfolios_df, ticker_config, log)
...
def execute_strategy_all(
    ...
    for i, ticker in enumerate(tickers):
        ...
        ticker_portfolios = process_ticker_portfolios_all(formatted_ticker, ticker_config, log)
