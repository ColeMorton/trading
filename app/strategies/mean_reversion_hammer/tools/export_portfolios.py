...
mean reversion hammer strategy using the centralized export functionality.
"""
...
def export_portfolios(
    ...
    try:
        ...
        # csv/mean_reversion_hammer/portfolios/ or
        # csv/mean_reversion_hammer/portfolios_scanner/
        feature1 = (
            ""
            if export_type in ["portfolios", "portfolios_scanner"]
            else "mean_reversion_hammer"
        )
