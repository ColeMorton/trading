"""
Sensitivity Analysis Module for Mean Reversion Hammer Strategy

This module performs sensitivity analysis on mean reversion hammer strategy parameters,
...
from app.mean_reversion_hammer.tools.signal_generation import (
    calculate_signals,
    is_signal_current,
)
...
def analyze_parameter_combination(
    ...
    Args:
        data: Price data DataFrame with OHLC data
        change_pct: Percentage difference between Low and Close prices for entry
...
def analyze_parameter_combinations(
    ...
    Args:
        data: Price data DataFrame with OHLC data
        change_pcts: List of Low-Close difference percentages
        config: Configuration dictionary
        log: Logging function for recording events and errors
