"""
Portfolio Analysis Module for Mean Reversion Hammer Strategy

This module handles portfolio analysis for the mean reversion hammer strategy, supporting both
single ticker and multiple ticker analysis. The strategy identifies hammer patterns where:

Long:
- Entry when Price Close is greater than Price Open AND Price Low is less than Price Open by change_pct
- Exit at beginning of next candle

Short:
- Entry when Price Close is less than Price Open AND Price High is greater than Price Open by change_pct
- Exit at beginning of next candle
