...
from app.mean_reversion.config_types import DEFAULT_CONFIG, PortfolioConfig
from app.mean_reversion.tools.export_portfolios import (
...
def run(config: PortfolioConfig = DEFAULT_CONFIG) -> bool:
    ...
    log, log_close, _, _ = setup_logging(
        module_name="mean_reversion", log_file="1_get_portfolios.log"
    )
