...
def run(config: PortfolioConfig = DEFAULT_CONFIG) -> bool:
    ...
    log, log_close, _, _ = setup_logging(
        module_name="macd_cross", log_file="1_get_portfolios.log"
    )
        ...
        for ticker in tickers:
            ...
            if filtered_portfolios is not None:
                ...
                try:
                    ...
                    from app.macd_next.tools.portfolio_selection import (
                        get_best_portfolio,
                    )
...
def run_strategies() -> bool:
    ...
    try:
        # Initialize logging
        log, log_close, _, _ = setup_logging(
            module_name="macd_next", log_file="1_get_portfolios.log"
        )
