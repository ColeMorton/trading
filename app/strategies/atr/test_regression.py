...
class TestATRRegressionPrevention(unittest.TestCase):
    ...
    def test_prevent_always_true_entry_signals(self):
        ...
        self.assertLessEqual(
            entry_signals, exit_signals * 2,  # Allow some ratio tolerance
    ...
    def test_prevent_hardcoded_period_values(self):
        ...
        self.assertEqual(
            result['Fast Period'], test_atr_length,
        ...
        self.assertEqual(
            result['Slow Period'], expected_slow_period,
    ...
    def test_prevent_excessive_trade_generation(self):
        ...
        self.assertLess(
            total_trades, 50,  # Much less than bug level of 70+
    ...
    def test_prevent_duration_export_errors(self):
        ...
        for field in duration_fields:
            ...
            if isinstance(value, (int, float)):
                self.assertFalse(np.isnan(value), f"Duration field {field} should not be NaN")
    ...
    def test_prevent_atr_calculation_regression(self):
        ...
        controlled_prices = [100, 102, 101, 105, 103, 107, 104, 108, 106, 110,
                           108, 112, 109, 113, 111, 115, 112, 116, 114, 118]
    ...
    def test_prevent_position_calculation_regression(self):
        ...
        for i in range(len(signals_df)):
            ...
            if in_position and prev_trailing_stop is not None and not pd.isna(prev_trailing_stop):
                self.assertGreaterEqual(
                    trailing_stop, prev_trailing_stop - 1e-6,  # Allow small floating point tolerance
