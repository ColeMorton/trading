...
from app.mean_reversion_rsi.config_types import DEFAULT_CONFIG, PortfolioConfig
from app.mean_reversion_rsi.tools.export_portfolios import (
...
def run(config: PortfolioConfig = DEFAULT_CONFIG) -> bool:
    ...
    log, log_close, _, _ = setup_logging(
        module_name="mean_reversion_rsi", log_file="1_get_portfolios.log"
    )
