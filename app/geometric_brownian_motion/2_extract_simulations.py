...
# Read the CSV file
with open(f'csv/geometric_brownian_motion/{TICKER}_gbm_simulations.csv', 'r') as file:
...
simulations_df.to_csv(f'csv/geometric_brownian_motion/{TICKER}_gbm_extracted_simulations.csv')
print(f"Simulations saved to csv/geometric_brownian_motion/{TICKER}_gbm_extracted_simulations.csv")
