...
def demonstrate_variance_issue():
    ...
    # Calculate both ways
    legacy = calc.calculate_from_components(win_rate, avg_win, avg_loss, legacy_mode=True)
    fixed = calc.calculate_from_components(win_rate, avg_win, avg_loss, legacy_mode=False)
    ...
    legacy_normal = calc.calculate_from_components(win_rate, avg_win, avg_loss_normal, legacy_mode=True)
    fixed_normal = calc.calculate_from_components(win_rate, avg_win, avg_loss_normal, legacy_mode=False)
