...
class ConcurrencyAnalysis:
    ...
    def analyze(self, data_list: List[pl.DataFrame], config_list: List[StrategyConfig]) -> Dict[str, Any]:
        ...
        stats = analyze_concurrency(data_list, config_list, self.log, config=self.config)
        return stats
    ...
    def run(self) -> Dict[str, Any]:
        ...
        # Load portfolio
        from app.tools.portfolio import load_portfolio, resolve_portfolio_path
        ...
        # Run analysis
        stats = analyze_concurrency(aligned_data, config_list, self.log, config=self.config)
