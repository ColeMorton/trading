...
def calculate_allocations(
    ...
    strategy_ids = [metrics.get("strategy_id", f"strategy_{i+1}") 
    ...
    if mode == AllocationMode.EQUAL:
        ...
        max_drawdowns = [metrics.get("max_drawdown", 1.0) for metrics in strategy_metrics]
        ...
        for mode, metrics in results.items():
            if mode != "signal_count":
                impact = {
                    ...
                    "max_drawdown_impact": metrics["max_drawdown"] - baseline["max_drawdown"]
                }
