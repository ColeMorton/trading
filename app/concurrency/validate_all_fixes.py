...
def main():
    ...
    print(f"USE_FIXED_EXPECTANCY_CALC: {config.get('USE_FIXED_EXPECTANCY_CALC', False)}")
    ...
    try:
        ...
        report_path = project_root / "logs" / f"fix_validation_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
        ...
        with open(report_path, 'w') as f:
            json.dump({
                ...
                "fixes_enabled": {
                    ...
                    "USE_FIXED_EXPECTANCY_CALC": config.get('USE_FIXED_EXPECTANCY_CALC', False),
                    "USE_FIXED_WIN_RATE_CALC": config.get('USE_FIXED_WIN_RATE_CALC', False),
                    "USE_FIXED_SIGNAL_PROC": config.get('USE_FIXED_SIGNAL_PROC', False)
                },
