...
class NewArchitectureTest:
    ...
    async def test_portfolio_analysis(self, portfolio_size: int) -> Dict[str, Any]:
        ...
        console.print(f"[cyan]Testing portfolio analysis ({portfolio_size} positions)[/cyan]")
        ...
        try:
            ...
            return {
                ...
                "success": True,
                "error": None,
                "sample_result": list(results.values())[0].to_dict() if results else None
            }
    ...
    def display_results(self):
        ...
        for result in self.test_results:
            ...
            elif "sample_result" in result and result.get("sample_result", {}).get("strategy_name"):
        ...
        if successful_tests:
            ...
            sample_result = next((r["sample_result"] for r in successful_tests if r["sample_result"]), None)
            if sample_result:
