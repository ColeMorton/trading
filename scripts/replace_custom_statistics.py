...
class StatisticalLibraryConsolidator:
    ...
    def __init__(self):
        self.divergence_detector_path = Path("app/tools/analysis/divergence_detector.py")
        self.replacements = []
    ...
    def analyze_custom_implementations(self):
        ...
        # Display analysis
        table = Table(title="Custom Statistical Implementations Analysis", show_header=True)
        ...
        console.print(f"Primary consolidation opportunity: _estimate_percentile_rank (230 lines)")
...
'''
        ...
        console.print(Panel(simplified_code, title="Simplified Statistical Methods", border_style="green"))
...
"""
        ...
        console.print(f"[green]✅ Implementation script created: apply_statistical_consolidation.py[/green]")
        
        return script_content
    
    def run_consolidation_analysis(self):
        """Run complete consolidation analysis."""
        console.print("[bold blue]🔬 SPDS Statistical Library Consolidation Analysis[/bold blue]")
        console.print("=" * 70)
        ...
        console.print("1. **Primary Target**: Replace _estimate_percentile_rank (230 lines → 15 lines)")
        console.print("2. **Secondary**: Use scipy.stats.norm.cdf for z-score conversions")
        console.print("3. **Keep Custom**: _calculate_iqr_position (domain-specific logic)")
        ...
        console.print("Next: Implement the consolidation using apply_statistical_consolidation.py")
