...
async def setup_database():
    ...
    try:
        ...
        try:
            ...
            logger.info("⚠️ You can run migration later with: python app/database/migrations.py")
        ...
        logger.info(f"✅ Initial data: {strategy_count} strategies, {ticker_count} tickers")
