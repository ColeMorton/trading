...
class TestErrorHandling(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Create test data
        self.test_df_pd = pd.DataFrame({"A": [1, 2, 3], "B": [4, 5, 6], "C": [7, 8, 9]})

        self.test_df_pl = pl.DataFrame({"A": [1, 2, 3], "B": [4, 5, 6], "C": [7, 8, 9]})
    ...
    def test_validate_numeric_array_success(self):
        ...
        try:
            self.error_handler.validate_numeric_array(self.test_array, "Test array")
            # If no exception is raised, the test passes
            self.assertTrue(True)
        except Exception as e:
    ...
    def test_convenience_functions(self):
        ...
        result = validate_dataframe(self.test_df_pd, ["A", "B"], "Test DataFrame")
