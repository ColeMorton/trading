...
class TestSignalProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_data = pd.DataFrame({
            ...
            'Slow_MA': slow_ma,
            'Signal': signals,
            'Position': signals.shift(1).fillna(0),  # Positions lag signals by 1 day
    ...
    def test_filtered_signal_counting(self):
        ...
        valid_rsi_buy = valid_signals[buy_signals]['RSI'] <= self.signal_def.rsi_oversold
        valid_rsi_sell = valid_signals[sell_signals]['RSI'] >= self.signal_def.rsi_overbought
    ...
    def test_position_signal_counting(self):
        ...
        position_count = self.processor.count_position_signals(self.test_data, self.signal_def)
    ...
    def test_comprehensive_counts(self):
        ...
        counts = self.processor.get_comprehensive_counts(self.test_data, self.signal_def)
    ...
    def test_signal_reconciliation(self):
        ...
        expected_keys = [
            'raw_signals', 'filtered_signals', 'position_signals', 'trade_signals',
            'filter_efficiency', 'execution_efficiency', 'trade_efficiency', 
            'overall_efficiency'
        ]
        ...
        if counts.raw_signals > 0:
            ...
            self.assertAlmostEqual(reconciliation['overall_efficiency'], expected_overall, places=6)
    ...
    def test_signal_standardization(self):
        ...
        standardized = self.processor.standardize_signal_column(test_data, method="crossover")
    ...
    def test_polars_compatibility(self):
        ...
        raw_count_polars = self.processor.count_raw_signals(polars_data, self.signal_def)
        raw_count_pandas = self.processor.count_raw_signals(self.test_data, self.signal_def)
        
        self.assertEqual(raw_count_polars, raw_count_pandas)
        
        # Test filtered signal counting
        filtered_count_polars, _ = self.processor.count_filtered_signals(polars_data, self.signal_def)
        filtered_count_pandas, _ = self.processor.count_filtered_signals(self.test_data, self.signal_def)
    ...
    def test_convenience_function(self):
        ...
        direct_filtered, _ = self.processor.count_filtered_signals(self.test_data, self.signal_def)
        direct_position = self.processor.count_position_signals(self.test_data, self.signal_def)
    ...
    def test_signal_definition_validation(self):
        ...
        strict_count, _ = self.processor.count_filtered_signals(self.test_data, strict_def)
        lenient_count, _ = self.processor.count_filtered_signals(self.test_data, lenient_def)
...
class TestSignalVarianceFix(unittest.TestCase):
    ...
    def test_signal_variance_analysis(self):
        ...
        counts = self.processor.get_comprehensive_counts(self.variance_data, self.signal_def)
    ...
    def test_consistency_across_methods(self):
        ...
        method1_count = self.processor.count_raw_signals(self.variance_data, self.signal_def)
    ...
    def test_variance_reduction(self):
        ...
        module2_count = self.processor.count_raw_signals(self.variance_data, self.signal_def)
