...
class TestPortfolioOrchestrator(unittest.TestCase):
    ...
    def test_get_strategies(self, mock_get_strategy_types):
        ...
        mock_get_strategy_types.assert_called_once_with(self.config, self.mock_log, "SMA")
    ...
    def test_execute_strategies(self):
        ...
        self.assertEqual(self.orchestrator.ticker_processor.execute_strategy.call_count, 2)
    ...
    def test_run_full_workflow(self, mock_export, mock_filter, mock_execute,
                              mock_get_strategies, mock_synthetic, mock_init_config):
    ...
    def test_run_no_portfolios(self):
        ...
        self.orchestrator._process_synthetic_configuration = Mock(return_value=self.config)
