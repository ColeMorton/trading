...
class TestCalculateSignalUnconfirmed:
    ...
    def test_return_value_types(self):
        ...
        test_cases = [
            ...
            pl.DataFrame({
                "MA_FAST": [110.0], "MA_SLOW": [100.0],
                "Signal": [0], "Position": [0], "timestamp": ["2023-01-01"],
                "Signal Entry": [False], "Signal Exit": [False]
            }),
            # Exit scenario (no confirmed signals)
            pl.DataFrame({
                "MA_FAST": [90.0], "MA_SLOW": [100.0],
                "Signal": [1], "Position": [1], "timestamp": ["2023-01-01"],
                "Signal Entry": [False], "Signal Exit": [False]
            }),
            ...
            pl.DataFrame({
                "MA_FAST": [110.0], "MA_SLOW": [100.0],
                "Signal": [1], "Position": [1], "timestamp": ["2023-01-01"],
                "Signal Entry": [True], "Signal Exit": [False]
            }),
        ]
        ...
        for test_data in test_cases:
            ...
            assert result in valid_returns, f"Result '{result}' not in valid returns {valid_returns}"