...
from app.database.models import MetricType, StrategySweepResult, StrategySweepResultMetric
...
class TestMetricTypeRepository:
    ...
    def test_parse_metric_type_string_multiple(self):
        ...
        result = repo._parse_metric_type_string("Most Sharpe Ratio, Most Total Return [%]")
...
class TestMetricTypeSeedData:
    ...
    def test_seed_data_coverage(self):
        ...
        for expected in expected_metrics:
            assert expected in names, f"Expected metric type '{expected}' not found in seed data"
