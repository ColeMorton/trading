...
class TestEnhancedMACrossService:
    ...
    def test_execute_analysis_with_full_portfolio(self, service, sample_request, 
    ...
    def test_execute_analysis_with_progress_tracker(self, service, sample_request,
                                                    mock_execute_strategy):
    ...
    def test_execute_analysis_with_multiple_tickers(self, service, mock_execute_strategy):
        ...
        mock_execute_strategy.return_value = [
            {'Ticker': 'BTC-USD', 'Strategy': 'SMA', 'Total_Return': 0.45, 'SMA_FAST': 20, 'SMA_SLOW': 50},
            {'Ticker': 'ETH-USD', 'Strategy': 'SMA', 'Total_Return': 0.38, 'SMA_FAST': 20, 'SMA_SLOW': 50},
            {'Ticker': 'SOL-USD', 'Strategy': 'SMA', 'Total_Return': 0.62, 'SMA_FAST': 20, 'SMA_SLOW': 50}
        ]
    ...
    def test_execute_analysis_error_handling(self, service, sample_request,
                                             mock_execute_strategy):
    ...
    def test_async_execution_with_progress_tracking(self, service, sample_request,
                                                    mock_execute_strategy):
    ...
    def test_portfolio_csv_export_paths(self, service, sample_request,
                                        mock_execute_strategy):
        ...
        with patch('os.listdir') as mock_listdir:
            ...
            assert any('BTC-USD' in path for path in response.portfolio_exports['portfolios'])
