...
async def test_portfolio_integration_with_api():
    ...
    try:
        ...
        try:
            ...
            result = await portfolio_tools.update_portfolio("test_positions.csv", "strategies")
...
async def test_tool_call_handler():
    ...
    try:
        ...
        result = await server.portfolio_tools.handle_tool_call("update_portfolio", arguments_invalid)
