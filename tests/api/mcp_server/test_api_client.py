...
from mcp_server.handlers.api_client import APIClient, APIError, APIConnectionError, APITimeoutError, get_api_client, cleanup_api_client
...
async def test_mock_requests():
    ...
    with patch.object(client, '_make_request') as mock_request:
        ...
        mock_response.json.return_value = {"status": "success", "data": ["script1.py", "script2.py"]}
    ...
    with patch.object(client, '_make_request') as mock_request:
        ...
        result = await client.post("/api/scripts/execute", json_data={"script": "test.py"})
