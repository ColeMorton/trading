...
class TestExportIntegration:
    ...
    def test_orchestrator_with_new_export(self, test_config, sample_portfolios):
        ...
        with patch('pathlib.Path.mkdir'), \
            ...
            assert any("Exported 2 portfolios" in str(call) for call in log.call_args_list)
    ...
    def test_orchestrator_backward_compatibility(self, test_config, sample_portfolios):
        ...
        with patch('app.tools.strategy.export_portfolios.export_portfolios') as mock_export:
            # Mock the sort_portfolios function to return the input
            with patch('app.tools.portfolio.collection.sort_portfolios', return_value=sample_portfolios):
                # Test export
                orchestrator._export_results(sample_portfolios, test_config)
    ...
    def test_batch_export_integration(self, test_config):
        ...
        with patch('pathlib.Path.mkdir'), \
            ...
            batch_logs = [call for call in log.call_args_list if "Batch export" in str(call)]
