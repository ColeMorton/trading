...
from app.tools.export.interfaces import ExportFormat, ExportContext
...
class TestExportManager:
    ...
    def test_export_error_handling(self, export_config, sample_dataframe):
        ...
        with patch('pathlib.Path.mkdir', side_effect=OSError("Permission denied")):
            ...
            assert any("Failed to create directory" in str(call) for call in error_calls)
...
class TestCSVExporter:
    ...
    def test_csv_column_validation(self, export_config):
        ...
        with patch('pathlib.Path.mkdir'), \
            ...
            warning_calls = [call for call in log.call_args_list if call[0][1] == "warning"]
