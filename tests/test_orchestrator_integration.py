...
class TestOrchestratorIntegration(unittest.TestCase):
    ...
    def test_orchestrator_workflow(self, mock_export, mock_filter, mock_execute,
                                  mock_get_strategies, mock_synthetic, mock_config_service):
    ...
    def test_filter_portfolios_import(self, mock_filter):
        ...
        with patch('app.tools.orchestration.portfolio_orchestrator.detect_schema_version'):
