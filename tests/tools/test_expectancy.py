...
class TestExpectancy(unittest.TestCase):
    ...
    def test_calculate_expectancy_metrics(self):
        ...
        self.assertAlmostEqual(metrics["Expectancy per Month"], expected_monthly, places=6)
        ...
        self.assertEqual(metrics["Expectancy per Trade"], metrics["Expectancy with Stop Loss"])
