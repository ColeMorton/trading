...
class TestRunner:
    ...
    def run_unit_tests(self):
        ...
        self.run_command(
            ["python", "-m", "pytest", "tests/strategies/", "-v", "--tb=short", "-k", "not integration"],
    ...
    def run_integration_tests(self):
        ...
        self.run_command(
            ["python", "-m", "pytest", "tests/test_portfolio_orchestrator.py", "-v", "--tb=short"],
            "Portfolio Orchestrator Tests"
        )
        
        # Export integration tests
        self.run_command(
            ["python", "-m", "pytest", "tests/test_export_integration.py", "-v", "--tb=short"],
            "Export Integration Tests"
        )
        
        # Strategy integration tests
        self.run_command(
            ["python", "-m", "pytest", "tests/test_strategy_integration.py", "-v", "--tb=short"],
            "Strategy Integration Tests"
        )
    ...
    def run_api_tests(self):
        ...
        # API unit tests
        self.run_command(
            ["python", "-m", "pytest", "tests/api/", "-v", "--tb=short", "-k", "not server"],
            "API Unit Tests"
        )
