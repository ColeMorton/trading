...
class TestSingleOperationBenchmarks(TestMACrossPerformanceBenchmarks):
    ...
    def test_portfolio_filtering_performance(self, large_portfolio_dataset, performance_config, mock_log):
        ...
        for _ in range(100):
            filtered_df = filter_service.filter_portfolios_dataframe(portfolios_df, performance_config, mock_log)
...
class TestWorkflowBenchmarks(TestMACrossPerformanceBenchmarks):
    ...
    def test_single_ticker_workflow_benchmark(self, performance_config, large_price_dataset, large_portfolio_dataset, mock_log):
        ...
        with patch('app.tools.get_data.get_data') as mock_get_data, \
            ...
            mock_filter_instance.filter_portfolios_dataframe.return_value = pl.DataFrame(large_portfolio_dataset[:10])
    ...
    def test_multiple_ticker_workflow_benchmark(self, performance_config, large_price_dataset, large_portfolio_dataset, mock_log):
    ...
    def test_multi_strategy_workflow_benchmark(self, performance_config, large_price_dataset, large_portfolio_dataset, mock_log):
...
class TestMemoryBenchmarks(TestMACrossPerformanceBenchmarks):
    ...
    def test_workflow_memory_usage(self, performance_config, large_price_dataset, large_portfolio_dataset, mock_log):
    ...
    def test_memory_cleanup(self, performance_config, large_price_dataset, large_portfolio_dataset, mock_log):
...
class TestConcurrencyBenchmarks(TestMACrossPerformanceBenchmarks):
    ...
    def test_concurrent_ticker_processing(self, performance_config, large_price_dataset, large_portfolio_dataset, mock_log):
...
class TestScalabilityBenchmarks(TestMACrossPerformanceBenchmarks):
    ...
    def test_data_processing_scalability(self, performance_config, mock_log, data_points):
        ...
        with patch('app.tools.get_data.get_data') as mock_get_data, \
            ...
            mock_filter_instance = Mock()
            mock_filter_instance.filter_portfolios_dataframe.return_value = pl.DataFrame([{
                "TICKER": "BTC-USD",
                "Strategy Type": "SMA",
                "Total Return [%]": 15.5
            }])
