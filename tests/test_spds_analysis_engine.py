...
from app.tools.models.spds_models import AnalysisResult, ExitSignal, SignalType, RiskLevel
...
class TestSPDSAnalysisEnginePerformance:
    ...
    async def test_memory_efficiency(self, engine, create_large_portfolio):
        ...
        print(f"  Per position: {memory_increase / len(results):.2f} MB" if results else "N/A")
