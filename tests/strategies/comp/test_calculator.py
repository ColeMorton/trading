...
class TestCalculateComponentPosition:
    ...
    def test_calculate_component_position_sma(self, sample_data, config, log_func):
        ...
        with patch('app.strategies.comp.calculator.calculate_ma_and_signals') as mock_calc:
    ...
    def test_calculate_component_position_macd(self, sample_data, config, log_func):
        ...
        with patch('app.strategies.comp.calculator.calculate_macd_and_signals') as mock_calc:
            mock_data = sample_data.clone()
            mock_data = mock_data.with_columns([
                pl.Series('Position', [0] * 100)
            ])
            mock_calc.return_value = mock_data
    ...
    def test_calculate_component_position_unsupported(self, sample_data, config, log_func):
...
class TestGenerateCompoundSignals:
    ...
    def test_generate_compound_signals_entry(self):
        ...
        data = pl.DataFrame({
            ...
            'percentage_in_position': [30.0, 40.0, 55.0, 60.0, 70.0, 65.0, 55.0, 45.0, 40.0, 30.0],
    ...
    def test_generate_compound_signals_exit(self):
        ...
        data = pl.DataFrame({
            'Date': pd.date_range('2024-01-01', periods=10, freq='D'),
            'percentage_in_position': [60.0, 70.0, 65.0, 55.0, 45.0, 40.0, 30.0, 35.0, 40.0, 45.0],
    ...
    def test_generate_compound_signals_stays_in_position(self):
        ...
        data = pl.DataFrame({
            'Date': pd.date_range('2024-01-01', periods=10, freq='D'),
            'percentage_in_position': [60.0, 65.0, 70.0, 75.0, 80.0, 75.0, 70.0, 65.0, 60.0, 55.0],
...
class TestCalculateCompoundStrategy:
    ...
    def test_calculate_compound_strategy_success(self, sample_csv, sample_data):
        ...
        with patch('app.strategies.comp.calculator.calculate_component_position') as mock_pos:
            # Mock component positions
            mock_pos.return_value = pl.Series([1, 0, 1, 0] * 25)

            result = calculate_compound_strategy(sample_data, sample_csv, config, log_func)
    ...
    def test_calculate_compound_strategy_no_strategies(self, sample_data):
        ...
        try:
            ...
            result = calculate_compound_strategy(sample_data, csv_path, config, log_func)
