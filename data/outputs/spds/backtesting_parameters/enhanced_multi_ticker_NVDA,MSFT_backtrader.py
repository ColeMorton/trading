...
class MSFT_ASSET_DISTRIBUTION_MSFT_DExitStrategy(bt.Strategy):
    """
    Statistical exit strategy for MSFT_ASSET_DISTRIBUTION_MSFT_D
    Generated from SPDS analysis
...
strategy_registry = {
    ...
    "MSFT_ASSET_DISTRIBUTION_MSFT_D": MSFT_ASSET_DISTRIBUTION_MSFT_DExitStrategy,
}
