...
**Generated**: July 22, 2025 12:05:06
...
- **Total Unrealized P&L**: -2.19% (Moderate)
- **Success Rate**: 0.0% (0 of 3 positions profitable)
- **Average Performance**: -0.73% per position
...
| -------- | ----------- | ------------------- | ---------- | ----------- |
| HWM      | **HOLD**    | Continue monitoring | 82.3%      | -1.40%      |
| RJF      | **HOLD**    | Continue monitoring | 79.7%      | -0.80%      |
| DOV      | **HOLD**    | Continue monitoring | 67.9%      | N/A         |

### 📁 Export Files Generated:

- **Backtesting parameters**: `data/outputs/spds/backtesting_parameters/protected.json` & `data/outputs/spds/backtesting_parameters/protected.csv`
