...
sp100_groups = [
    sp100_group1, sp100_group2, sp100_group3,
    sp100_group4, sp100_group5, sp100_group6
]
...
total_sp100_exclusive = len(sp100_all_tickers)  # Should be 54 stocks after removing QQQ overlaps