...
class TSLA_SMA_15_25_TSLA_DExitStrategy(bt.Strategy):
    """
    Statistical exit strategy for TSLA_SMA_15_25_TSLA_D
    Generated from SPDS analysis
    ...
    def __init__(self):
        ...
        # Validate parameters
        if self.params.statistical_validity == "LOW":
            print(f"Warning: Low reliability parameters for TSLA_SMA_15_25_TSLA_D")
...
strategy_registry = {
    ...
    "TSLA_SMA_15_25_TSLA_D": TSLA_SMA_15_25_TSLA_DExitStrategy,
}
